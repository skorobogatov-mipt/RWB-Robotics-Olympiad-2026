...
`wb-software-workspace/src/solution_python/solution_pyhon/solution.py`

Ваше решение должно находиться в этом файле. Если вы чувствуете себя
продвинутым и умеете писать ROS-пакеты, то можете писать их.
